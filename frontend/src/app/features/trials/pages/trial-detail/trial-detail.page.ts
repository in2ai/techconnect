            ...
            <div class="tab-content in-vivo-content">
              ...
              <div class="section-container">
                ...
                @if (measuresResource.isLoading()) {
                  ...
                  <app-loading-state
                    status="error"
                    i18n-errorMessage="@@failedToLoadMeasures"
                  ...
                  <app-loading-state
                    ...
                    i18n-emptyTitle="@@noMeasuresTitle"
                    emptyTitle="No measures"
                    i18n-emptyMessage="@@noMeasuresMsg"
            ...
            <div class="tab-content in-vivo-content">
              <div class="section-container">
                ...
                @if (facsResource.isLoading()) {
                  ...
                  <app-loading-state
                    status="error"
                    i18n-errorMessage="@@failedToLoadFacs"
                  ...
                  <app-loading-state
                    status="empty"
                    emptyIcon="biotech"
                    i18n-emptyTitle="@@noFacsDataTitle"
                    emptyTitle="No FACS data"
                    i18n-emptyMessage="@@noFacsDataMsg"
            ...
            <div class="section-container">
              ...
              @if (biomodelsResource.isLoading()) {
                ...
                <app-loading-state
                  status="empty"
                  emptyIcon="science"
                  i18n-emptyTitle="@@trialNoBiomodelsTitle"
                  emptyTitle="No biomodels"
                  i18n-emptyMessage="@@trialNoBiomodelsMsg"
            ...
            <div class="section-container">
              ...
              @if (genomicResource.isLoading()) {
                ...
                <app-loading-state
                  ...
                  i18n-emptyMessage="@@noGenomicDataMsg"
            ...
            <div class="section-container">
              ...
              @if (molecularResource.isLoading()) {
                ...
                <app-loading-state
                  ...
                  i18n-emptyMessage="@@noMolecularDataMsg"
