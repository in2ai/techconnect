...
description: Comprehensive guidance for writing, debugging, and maintaining Playwright tests in TypeScript. Covers E2E, component, API, visual, accessibility, security, Electron, and extension testing. Includes handling flaky tests, CI/CD setup, Page Object Model, performance tuning, API mocking, auth/OAuth, file uploads, date/time control, WebSockets, geolocation, permissions, multi-tab flows, responsive/mobile, GraphQL, error handling, offline mode, third-party integrations, console monitoring, test hooks, annotations, dependencies, iframes, service workers, coverage, and i18n.
license: MIT
metadata:
  author: currents.dev
  version: "1.0"
